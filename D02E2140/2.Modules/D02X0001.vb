...
Module D02X0001
    ...
    ''' <summary>
    ''' Module đang coding D02E2140
    ''' </summary>
    Public Const MODULED02 As String = "D02E2140"
    ''' <summary>
    ''' Chuỗi D02
    ''' </summary>
    ...
    'Public D02CustomFormat As StructureCustomFormat
    ...
    Public giFirstTranMonth As Integer 'Số dư đầu kỳ
    Public giFirstTranYear As Integer 'Số dư đầu kỳ
